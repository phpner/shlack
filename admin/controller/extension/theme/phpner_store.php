...
class ControllerExtensionThemePhpnerStore extends Controller
{
    ...
    public function main()
    {
        ...
        if( $this->request->server["REQUEST_METHOD"] == "POST" && $this->validate() )
        {
            ...
            $curl_data['phpner_store_data'] = $post['phpnerSettingsForm'];

            unset($post['phpnerSettingsForm']);
        ...
        if( isset($this->request->post["phpnerSettingsForm"]) )
        {
            $data["value_002"] = $this->request->post["phpnerSettingsForm"];
        } else
        {
