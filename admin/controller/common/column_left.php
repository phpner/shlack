...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		...
		/* phpner_eam */
			if ($this->user->hasPermission('access', 'phpner_eam/toolset')) {
				$tool[] = array(
					'name'	   => $this->language->get('text_phpner_eam_toolset'),
					'href'     => $this->url->link('phpner_eam/toolset', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
