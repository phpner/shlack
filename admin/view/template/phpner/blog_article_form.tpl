          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-links">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="main_phpner_blog_category_id" class="form-control">
                    <option value="0" selected="selected"><?php echo $text_none; ?></option>
                    <?php foreach ($blog_categories as $category) { ?>
                    <?php if ($category['phpner_blog_category_id'] == $main_phpner_blog_category_id) { ?>
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="min-height: 150px;max-height: 500px;overflow: auto;">
                    ...
                    <tr>
                      <td class="checkbox">
                        <label>
                          <?php if (in_array($article_category['phpner_blog_category_id'], $article_categories)) { ?>
                          <input type="checkbox" name="article_category[]" value="<?php echo $article_category['phpner_blog_category_id']; ?>" checked="checked" />
                          <?php echo $article_category['name']; ?>
                          <?php } else { ?>
                          <input type="checkbox" name="article_category[]" value="<?php echo $article_category['phpner_blog_category_id']; ?>" />
                          <?php echo $article_category['name']; ?>
                          <?php } ?>
                        </label>
                      </td>
                ...
                <div class="col-sm-10">
                  ...
                  <div id="article-related" class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div id="article-related<?php echo $ra_row; ?>"><i class="fa fa-minus-circle"></i> <?php echo $article_related['name']; ?>
                      <input type="hidden" name="article_related[]" value="<?php echo $article_related['phpner_blog_article_id']; ?>" />
                    </div>
                    <?php $ra_row++; ?>
                    <?php } ?>
                  </div>
...
$('input[name=\'related_p\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
      url: 'index.php?route=phpner/blog_article/autocompleteProduct&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
      dataType: 'json',
      success: function(json) {
        response($.map(json, function(item) {
          return {
