          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($product['phpner_blog_article_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $product['phpner_blog_article_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $product['phpner_blog_article_id']; ?>" />
                    <?php } ?>
                  </td>
...
$('#button-filter').on('click', function() {
	var url = 'index.php?route=phpner/blog_article&token=<?php echo $token; ?>';
