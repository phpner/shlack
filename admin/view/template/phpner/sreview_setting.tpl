          ...
          <div class="tab-content">
            <div class="tab-pane active" id="setting-tab">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="phpner_sreview_setting_data[status]" id="input-status" class="form-control">
                    <?php if ($phpner_sreview_setting_data['status']) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="phpner_sreview_setting_data[review_moderation]" id="input-review_moderation" class="form-control">
                    <?php if ($phpner_sreview_setting_data['review_moderation']) { ?>
                    <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                    <option value="0"><?php echo $text_disabled; ?></option>
                    <?php } else { ?>
                    <option value="1"><?php echo $text_enabled; ?></option>
