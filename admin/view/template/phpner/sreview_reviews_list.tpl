          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($review['phpner_sreview_review_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $review['phpner_sreview_review_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $review['phpner_sreview_review_id']; ?>" />
                    <?php } ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=phpner/sreview_reviews&token=<?php echo $token; ?>';
...
$('input[name=\'filter_author\']').autocomplete({
  'source': function(request, response) {
    $.ajax({
      url: 'index.php?route=phpner/sreview_reviews/autocomplete&token=<?php echo $token; ?>&filter_author=' +  encodeURIComponent(request),
      dataType: 'json',
      success: function(json) {
        response($.map(json, function(item) {
          return {
            label: item['author'],
            value: item['phpner_sreview_review_id']
          }
        }));
      }
    });
