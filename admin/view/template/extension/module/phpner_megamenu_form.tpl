        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div style="<?php echo $item_type == 2 ? '' : 'display:none;'; ?>" id="phpner_megamenu_categories">
                <div class="form-group">
                      ...
                      <?php foreach ($categories as $category) { ?>
                        <div class="checkbox" style="padding-top: 1px; min-height: auto;">
                          <label>
                            ...
                            <input type="checkbox" name="phpner_megamenu_categories[]" value="<?php echo $category['category_id']; ?>" checked="checked" />
                            <?php echo $category['name']; ?>
                            <?php } else { ?>
                            <input type="checkbox" name="phpner_megamenu_categories[]" value="<?php echo $category['category_id']; ?>" />
                            <?php echo $category['name']; ?>
                            <?php } ?>
                          </label>
                        </div>
              ...
              <div class="form-group" style="<?php echo $item_type == 3 ? '' : 'display:none;'; ?>" id="phpner_megamenu_manufacturers">
                    ...
                    <?php foreach ($manufacturers as $manufacturer) { ?>
                      <div class="checkbox" style="padding-top: 1px; min-height: auto;">
                        <label>
                          ...
                          <input type="checkbox" name="phpner_megamenu_manufacturers[]" value="<?php echo $manufacturer['manufacturer_id']; ?>" checked="checked" />
                          <?php echo $manufacturer['name']; ?>
                          <?php } else { ?>
                          <input type="checkbox" name="phpner_megamenu_manufacturers[]" value="<?php echo $manufacturer['manufacturer_id']; ?>" />
                          <?php echo $manufacturer['name']; ?>
                          <?php } ?>
                        </label>
                      </div>
              ...
              <div class="form-group" style="<?php echo $item_type == 4 ? '' : 'display:none;'; ?>" id="phpner_megamenu_products">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="featured-product" class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div id="featured-product<?php echo $product['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product['name']; ?>
                      <input type="hidden" name="phpner_megamenu_products[]" value="<?php echo $product['product_id']; ?>" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
              </div>
              <div style="<?php echo $item_type == 5 ? '' : 'display:none;'; ?>" id="phpner_megamenu_informations">
                <div class="form-group">
                      ...
                      <?php foreach ($informations as $information) { ?>
                        <div class="checkbox" style="padding-top: 1px; min-height: auto;">
                          <label>
                            ...
                            <input type="checkbox" name="phpner_megamenu_informations[]" value="<?php echo $information['information_id']; ?>" checked="checked" />
                            <?php echo $information['title']; ?>
                            <?php } else { ?>
                            <input type="checkbox" name="phpner_megamenu_informations[]" value="<?php echo $information['information_id']; ?>" />
                            <?php echo $information['title']; ?>
                            <?php } ?>
                          </label>
                        </div>
              ...
              <div class="form-group" style="<?php echo $item_type == 7 ? '' : 'display:none;'; ?>" id="phpner_megamenu_custom_html">
                ...
                <div class="col-sm-10">
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="custom_html<?php echo $language['language_id']; ?>">
                      <textarea name="phpner_megamenu_description[<?php echo $language['language_id']; ?>][custom_html]" placeholder="<?php echo $entry_description; ?>" id="input-custom_html<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($phpner_megamenu_description[$language['language_id']]) ? $phpner_megamenu_description[$language['language_id']]['custom_html'] : ''; ?></textarea>
                    </div>
                    <?php } ?>
                  </div>
                </div>
            ...
            <div class="tab-pane" id="tab-language">
              ...
              <div class="tab-content">
                ...
                <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="phpner_megamenu_description[<?php echo $language['language_id']; ?>][link]" value="<?php echo isset($phpner_megamenu_description[$language['language_id']]) ? $phpner_megamenu_description[$language['language_id']]['link'] : ''; ?>" placeholder="<?php echo $entry_link; ?>" id="input-link<?php echo $language['language_id']; ?>" class="form-control" />
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="phpner_megamenu_description[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($phpner_megamenu_description[$language['language_id']]) ? $phpner_megamenu_description[$language['language_id']]['title'] : ''; ?>" placeholder="<?php echo $entry_title; ?>" id="input-title<?php echo $language['language_id']; ?>" class="form-control" />
                  ...
                  <div class="form-group for-product-only">
                    ...
                    <div class="col-sm-10">
                      <textarea name="phpner_megamenu_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($phpner_megamenu_description[$language['language_id']]) ? $phpner_megamenu_description[$language['language_id']]['description'] : ''; ?></textarea>
                    </div>
                  </div>
                </div>
                <?php } ?>
...
$('input[name=\'product\']').autocomplete({
  ...
  'select': function(item) {
    ...
    $('#phpner_megamenu-product' + item['value']).remove();
    
    $('#phpner_megamenu-product').append('<div id="phpner_megamenu-product' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="phpner_megamenu_product[]" value="' + item['value'] + '" /></div>');  
  } 
});

$('#phpner_megamenu-product').delegate('.fa-minus-circle', 'click', function() {
  $(this).parent().remove();
});
//--></script>
<script type="text/javascript"><!--
...
<script type="text/javascript"><!--
  $('select[name=item_type]').change(function() {
    var val = $(this).val();
    if (val == 1) {
      $('#phpner_megamenu_categories').hide();
      $('#phpner_megamenu_manufacturers').hide();
      $('#phpner_megamenu_products').hide();
      $('#phpner_megamenu_informations').hide();
      $('#phpner_megamenu_custom_html').hide();
      $('#additional_setting_block').hide();
      $('.for-category-only').hide();
      $('.not-for-category').show();
      $('#input-columns').attr('readonly', true);
      $('#phpner_megamenu_descr').hide();
      $('[name=info_text]').parent().parent().hide();
      $('.for-product-only').hide();
      $('[name=limit_item]').parent().parent().hide();
    } else if(val == 2) {
      $('#phpner_megamenu_categories').show();
      $('#phpner_megamenu_manufacturers').hide();
      $('#phpner_megamenu_products').hide();
      $('#phpner_megamenu_informations').hide();
      $('#phpner_megamenu_custom_html').hide();
      ...
      $('#phpner_megamenu_categories').hide();
      $('#phpner_megamenu_manufacturers').show();
      $('#phpner_megamenu_products').hide();
      $('#phpner_megamenu_informations').hide();
      $('#phpner_megamenu_custom_html').hide();
      $('#additional_setting_block').show();
      ...
      $('#phpner_megamenu_manufacturers').hide();
      $('#phpner_megamenu_products').hide();
      $('#phpner_megamenu_informations').show();
      $('#phpner_megamenu_custom_html').hide();
      $('#additional_setting_block').hide();
      $('.for-category-only').hide();
      $('.not-for-category').show();
      ...
      $('#phpner_megamenu_products').hide();
      $('#phpner_megamenu_informations').hide();
      $('#phpner_megamenu_custom_html').show();
      $('#additional_setting_block').hide();
      $('.for-category-only').hide();
      $('.not-for-category').show();
      $('#input-columns').attr('readonly', true);
...
$('input[name=\'product\']').autocomplete({
  ...
  select: function(item) {
    ...
    $('#featured-product').append('<div id="featured-product' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="phpner_megamenu_products[]" value="' + item['value'] + '" /></div>');
  }
});
