          ...
          <div class="tab-content">
            <div class="tab-pane active" id="setting-tab">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="phpner_popup_product_options_data[status]" id="input-status" class="form-control">
                    <?php if ($phpner_popup_product_options_data['status']) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="phpner_popup_product_options_data[show_quantity]" id="input-show_quantity" class="form-control">
