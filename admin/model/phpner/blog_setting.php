...
class ModelPhpnerBlogSetting extends Model {
    ...
    public function deleteTables() {
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_blog_category`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_blog_category_description`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_blog_category_to_layout`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_blog_category_to_store`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_blog_category_path`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_blog_article`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_blog_article_description`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_blog_article_image`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_blog_article_products_related`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_blog_article_articles_related`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_blog_article_to_category`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_blog_article_to_layout`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_blog_article_to_store`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_blog_comments`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_blog_comments_like`;");
    }
}