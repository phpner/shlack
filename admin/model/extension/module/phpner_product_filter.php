...
class ModelExtensionModulePhpnerProductFilter extends Model {
    public function makeDB() {
        $sql1 = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "phpner_filter_product_attribute` ( ";
        ...
        $sql2 = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "phpner_filter_product_option` ( ";
        ...
        $sql3 = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "phpner_filter_product_standard` ( ";
        ...
        $sql4 = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "phpner_filter_product_sticker` ( ";
        ...
        $sql5 = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "phpner_filter_product_manufacturer` ( ";
        ...
        $sql6 = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "phpner_filter_product_seo` (";
        ...
        $sql7 = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "phpner_filter_product_seo_description` (";
    ...
    public function removeDB() {
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_filter_product_attribute`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_filter_product_option`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_filter_product_standard`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_filter_product_sticker`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_filter_product_manufacturer`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_filter_product_seo`;");
        $this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_filter_product_seo_description`;");
    }
    ...
    public function getFilterGroups($data = array()) {
      ...
      SELECT 
        DISTINCT * 
      FROM `" . DB_PREFIX . "phpner_filter_product_standard` fpsd 
      WHERE 
    ...
    public function getAttributes($data = array()) {
      ...
      SELECT 
        DISTINCT * 
      FROM " . DB_PREFIX . "phpner_filter_product_attribute fpa 
      WHERE 
    ...
    public function getOptions($data = array()) {
      ...
      SELECT 
        DISTINCT * 
      FROM `" . DB_PREFIX . "phpner_filter_product_option` fpo 
      WHERE 
    ...
    public function addSeo($data) {
        $this->db->query("
      INSERT INTO " . DB_PREFIX . "phpner_filter_product_seo 
      SET 
    ...
    ");
        ...
        foreach ($data['form_description'] as $language_id => $value) {
            ...
            $this->db->query("
        INSERT INTO " . DB_PREFIX . "phpner_filter_product_seo_description 
        SET 
          seo_id = '" . (int) $seo_id . "', 
    ...
    public function editSeo($seo_id, $data) {
        $this->db->query("
      UPDATE " . DB_PREFIX . "phpner_filter_product_seo 
      SET 
        status = '" . (int) $data['status'] . "', 
        date_modified = NOW() 
      WHERE 
    ...
    ");
        ...
        $this->db->query("DELETE FROM " . DB_PREFIX . "phpner_filter_product_seo_description WHERE seo_id = '" . (int) $seo_id . "'");
    ...
    public function getSeo($seo_id) {
        return $this->db->query("SELECT * FROM " . DB_PREFIX . "phpner_filter_product_seo WHERE seo_id = '" . (int) $seo_id . "'")->row;
    }
    ...
    public function deleteSeo($seo_id) {
        $this->db->query("DELETE FROM " . DB_PREFIX . "phpner_filter_product_seo WHERE seo_id = '" . (int) $seo_id . "'");
        $this->db->query("DELETE FROM " . DB_PREFIX . "phpner_filter_product_seo_description WHERE seo_id = '" . (int) $seo_id . "'");
    ...
    public function deleteSeos() {
        $query = $this->db->query("SELECT seo_id FROM " . DB_PREFIX . "phpner_filter_product_seo")->rows;
        
        if ($query) {
            foreach ($query as $form) {
                $this->db->query("DELETE FROM " . DB_PREFIX . "phpner_filter_product_seo WHERE seo_id = '" . (int) $form['seo_id'] . "'");
                $this->db->query("DELETE FROM " . DB_PREFIX . "phpner_filter_product_seo_description WHERE seo_id = '" . (int) $form['seo_id'] . "'");
            }
    ...
    public function getSeoDescription($seo_id) {
        ...
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "phpner_filter_product_seo_description WHERE seo_id = '" . (int) $seo_id . "'")->rows;
