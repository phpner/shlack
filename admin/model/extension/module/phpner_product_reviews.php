...
class ModelExtensionModulePhpnerProductReviews extends Model {
	public function makeDB() {
		$sql1  = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "phpner_product_reviews` ( ";
		...
		$sql2  = "CREATE TABLE IF NOT EXISTS `" . DB_PREFIX . "phpner_product_reviews_reputation` ( ";
	...
	public function removeDB() {
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_product_reviews`;");
		$this->db->query("DROP TABLE IF EXISTS `" . DB_PREFIX . "phpner_product_reviews_reputation`;");
	}
}