...
class ModelCatalogProduct extends Model {
	...
	public function getProducts($data = array()) {
		...
		if (isset($phpner_product_filter_data['show_no_quantity_products']) and !$phpner_product_filter_data['show_no_quantity_products']) {
...
'p.viewed',
		...
		$sql .= " ORDER BY ";
		if (isset($phpner_product_filter_data['no_quantity_last']) and $phpner_product_filter_data['no_quantity_last']) {
