...
class ControllerExtensionModulePhpnerMegamenu extends Controller {
    ...
    public function index() {
        ...
        $data['phpner_megamenu_data'] = $phpner_megamenu_data;
        ...
        $menu_items = $this->cache->get('phpner_emplates.megamenu.' . (int) $this->config->get('config_language_id') . '.' . (int) $this->config->get('config_store_id') . '.' . $this->config->get('config_customer_group_id'));
        
        if (!$menu_items) {
            $results = $this->model_extension_module_phpner_megamenu->getMegamenus();
            ...
            foreach ($results as $result) {
                ...
                if ($result['item_type'] == 2) {
                    $children_data = $this->model_extension_module_phpner_megamenu->getMegamenuCategory($result['megamenu_id']);
                ...
                if ($result['item_type'] == 3) {
                    $children_data = $this->model_extension_module_phpner_megamenu->getMegamenuManufacturer($result['megamenu_id']);
                ...
                if ($result['item_type'] == 4) {
                    $children_data = $this->model_extension_module_phpner_megamenu->getMegamenuProduct($result['megamenu_id']);
                ...
                if ($result['item_type'] == 5) {
                    $children_data = $this->model_extension_module_phpner_megamenu->getMegamenuInformation($result['megamenu_id']);
            ...
            $this->cache->set('phpner_emplates.megamenu.' . (int) $this->config->get('config_language_id') . '.' . (int) $this->config->get('config_store_id') . '.' . $this->config->get('config_customer_group_id'), $menu_items);
        }
        
        $data['items'] = $menu_items;
        
        return $this->load->view('extension/module/phpner_megamenu', $data);
    }
