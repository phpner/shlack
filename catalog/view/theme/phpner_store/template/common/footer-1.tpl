		...
		<?php if ($phpner_store_data['foot_show_contact_link'] == 'on') { ?>
			...
			<div class="row first-row">
				...
				<div class="col-md-3 hidden-sm hidden-xs text-right">
					...
					<div class="col-md-12 col-sm-5 text-left socials-box">
						<?php if ($phpner_store_data['ps_facebook_id']) { ?>
						<a rel="nofollow" href="<?php echo $phpner_store_data['ps_facebook_id']; ?>" title="Facebook" target="_blank"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
						<?php } ?>
						...
						<a rel="nofollow" href="<?php echo $phpner_store_data['ps_youtube_id']; ?>" title="Youtube" target="_blank"><i class="fa fa-youtube" aria-hidden="true"></i></a>
						<?php } ?>
					</div>
			</div>
			<hr>
		  ...
		  <div class="row third-row">
		    ...
		    <div class="col-sm-3 footer-contacts">
				...
				<ul class="footer-contacts-ul">
					...
					<li><i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo $phpner_store_cont_adress; ?></li>
					<?php } ?>
