  ...
  <div class="col-sm-12  content-row">
    ...
    <div class="row">
      ...
      <div id="content" class="<?php echo $class; ?>">
        <?php if ($categories && $phpner_store_data['cat_show_subcat'] == 'on') { ?>
        <h3 class="subcat-header"><?php echo $phpner_choose_subcategory; ?></h3>
        ...
        <?php if ($products) { ?>
        <div class="row sort-row" <?php if ($phpner_store_data['cat_sorttype'] != 'on') { ?>style="display:none !important;"<?php } ?>>
              ...
              <div class="product-thumb<?php echo (isset($product['product_preorder_status']) && $product['product_preorder_status'] != 1 && $product['quantity'] <= 0) ? ' no_quantity' : ''?>">
                ...
                <div>
                  <div class="caption">
                    ...
                    <p class="phpner_-product-stock"><span class="hidden-xs"><?php echo $text_stock; ?></span> <span><?php echo $product['stock']; ?></span></p>
