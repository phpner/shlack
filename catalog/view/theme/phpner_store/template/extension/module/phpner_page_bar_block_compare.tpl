<div class="row phpner_-carousel-row">
	<div class="col-sm-12">
		<div class="phpner_-carousel-box">
			<div class="phpner_-carousel-header"><a href="<?php echo $compare; ?>"><?php echo $text_compare; ?></a></div>
			<div id="phpner_-compare-carousel" class="owl-carousel owl-theme">
                ...
                <?php } ?>
				  ...
				  <div class="cart">
				    ...
				    <a onclick="remove_compare('<?php echo $product['product_id']; ?>');" title="<?php echo $remove_compare; ?>" class="compare phpner_-button"><i class="fa fa-trash" aria-hidden="true"></i></a>
				  </div>
				</div>
				<?php } ?>
			</div>
...
<script>
$('#phpner_-compare-carousel').owlCarousel({
  items: 4,
  itemsDesktop : [1599,4],
  itemsDesktop : [1199,4],
