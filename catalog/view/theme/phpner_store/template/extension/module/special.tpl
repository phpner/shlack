...
<?php } ?>
  <div class="col-sm-12">
    <div class="phpner_-carousel-box">
      ...
      <div id="phpner_-special-<?php echo $module; ?>" class="owl-carousel owl-theme">
...
<script>
  $('#phpner_-special-<?php echo $module; ?>').owlCarousel({
    items: <?php if($position == "column_left" OR $position == "column_right") { echo 1; } else { echo 4; } ?>,
    itemsDesktop : [1921,<?php if($position == "column_left" OR $position == "column_right") { echo 1; } else { echo 5; } ?>],
