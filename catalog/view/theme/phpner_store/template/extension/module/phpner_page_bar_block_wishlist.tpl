<div class="row phpner_-carousel-row">
	<div class="col-sm-12">
		<div class="phpner_-carousel-box">
			<div class="phpner_-carousel-header"><a href="<?php echo $wishlist; ?>"><?php echo $text_wishlist; ?></a></div>
			<div id="phpner_-favorite-carousel" class="owl-carousel owl-theme">
                ...
                <?php } ?>
				  ...
				  <div class="cart">
				    ...
				    <?php } ?>
				    <a onclick="remove_wishlist('<?php echo $product['product_id']; ?>');" title="<?php echo $remove_wishlist; ?>" class="wishlist phpner_-button"><i class="fa fa-trash" aria-hidden="true"></i></a>
...
<script>
$('#phpner_-favorite-carousel').owlCarousel({
  items: 4,
  itemsDesktop : [1599,4],
  itemsDesktop : [1199,4],
