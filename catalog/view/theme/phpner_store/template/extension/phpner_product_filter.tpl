...
<?php } ?>
<?php if ($phpner_product_filter_data['pagination_type']) { ?>
      ...
      if (count_totals) {
        $.ajax({
          ...
          success: function(data) {
            ...
            if ($('#phpner_-product-filter-data input[type=\'checkbox\']:checked').length || $('#phpner_-product-filter-data input[type=\'radio\']:checked').length || $('#phpner_-product-filter-data select option:selected').length) {
